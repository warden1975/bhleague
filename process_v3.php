<?php
	...
	if(isset($code) && trim($code) != '' ){
		...
		$urli = WEPAY_DOMAIN_LIVE.WEPAY_ACCESSTOKEN_URI."?client_id=".WEPAY_CLIENT_ID_LIVE_TUE."&redirect_uri=".WEPAY_REDIRECT_URI_LIVE_TUE_V3."&client_secret=".WEPAY_CLIENT_SECRET_LIVE_TUE."&code=".$code;//XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
