	...
	if(@$action=='get_game_stats')
	{
		...
		$sql = "SELECT `game_date`,`game_time`,team1,team2,CONCAT(team1_score,' - ',team2_score) as score,team1_score,team2_score FROM bhleague.`schedule` WHERE game_date ='$gamedate' and team1 =$team1 and team2=$team2 and YEAR(game_date) = $current_year  ORDER by `game_date`,`game_time` ";
