  ...
  (function(d, s, id) {
	...
	<div class="container">
		<div id="header">
			...
			<div class="wrap">
				<div class="menu">
					...
					<div class="menu-link" style="text-align:inherit">
		...
		<div id="content">
			...
			<div class="col2 col">
				<h2 class="title"><?php echo (isset($s['game_dayname']) && trim($s['game_dayname'])!='' )?@$s['game_dayname']."’s":''; ?> Matches</h2>				
				<div class="sub"><?php echo (isset($s['game_date']) && trim($s['game_date'])!='' )?@$s['game_date']:"-"; ?></div>
				<div class="padding_clear"></div>
                <div id="grid-next_game" >
                </div>
			</div>
            <div id="div_fb" style="right:-30px;top:510px;position:absolute;z-index:999">
		...
		<div id="content" class="dark-c">
			...
			<div class="col col4">
                ...
                <tfoot>
                  <tr>
                    <td colspan="3"><a href="standings_v2.html" class="blue_link"><small>View complete rankings</small></a></td>
                  </tr>
                </tfoot>
					</table>
				</div>
