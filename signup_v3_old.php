...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript">
		...
		Ext.bhl.wepay_link = "<?php echo WEPAY_DOMAIN_LIVE.WEPAY_AUTHORIZE_URI.WEPAY_AUTHORIZE_PARAM_LIVE_TUE.WEPAY_REDIRECT_URI_LIVE_TUE_V3; ?>";
		Ext.bhl.wepay_link_sat = "<?php echo WEPAY_DOMAIN_LIVE.WEPAY_AUTHORIZE_URI.WEPAY_AUTHORIZE_PARAM_LIVE_SAT.WEPAY_REDIRECT_URI_LIVE_SAT_V3; ?>";
		Ext.bhl.wepay_link_sun = "<?php echo WEPAY_DOMAIN_LIVE.WEPAY_AUTHORIZE_URI.WEPAY_AUTHORIZE_PARAM_LIVE_SUN.WEPAY_REDIRECT_URI_LIVE_SUN_V3; ?>";
	                        ...
	                        <div id="div_frm" class="form-reg" >
										...
										<table style="padding-top:20px; padding-bottom:20px;" >
											...
											<tr>
												<td align="right" valign="middle" style="padding-left:10px;"></td>
												 <td style="padding-left:10px; padding-bottom:2px;" valign="top"></td>
												<td style="padding-left:10px; padding-bottom:2px;" valign="top"><a class="button" onclick="Ext.bhl.proc();" href="#"><span><b>Submit</b></span></td>
											</tr>
										</table>
										</form>
									</div>
									<div class="form_right">									
										<div id="fade" class="pics">
											...
											<img src="http://bhleague.com/bhleague_logos/knicks_w.png" width="100%"/>	
											<img src="http://bhleague.com/bhleague_logos/reformed_w.png" width="100%"/>
											<img src="http://bhleague.com/bhleague_logos/wise_guys_w.png" width="100%"/>	
											
											<img src="http://bhleague.com/bhleague_logos/purple_rain_w.png" width="50%"/>
											<img src="http://bhleague.com/bhleague_logos/the_billy_hoyles_w.png" width="50%"/>
											<img src="http://bhleague.com/bhleague_logos/the_chemists_w.png" width="100%"/>										
											<img src="http://bhleague.com/bhleague_logos/shoot_kill_w.png" width="70%"/>	
