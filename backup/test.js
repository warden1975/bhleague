...
//		{name: 'score'}
//	]);
	var readerz = new Ext.data.ArrayReader({}, [
		{name: 'game_date',type:'date'},
		{name: 'game_time',type:'date'},
		{name: 'team1',},
		{name: 'team2'},
		{name: 'score'}
	]);
...
//			}, ds_model)
//	    });
	var proxyz = new Ext.data.HttpProxy({
		//where to retrieve data
		url: 'teams.php?action=get_team_stats_current&team_id=' + teamid, //url to data object (server side script)
		method: 'GET'
	});
