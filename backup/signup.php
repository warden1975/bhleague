...
?>     
	...
	<html xmlns="http://www.w3.org/1999/xhtml">
	  <head>
		...
		<script type="text/javascript" charset="utf-8" src="js_v2/cycle.js"></script>	
                            ...
                            <form name="frmaaddNotification" id="frmaaddNotification" method="post" action="signup_callback.php?action=insert&timestamp=<?php echo time() ?>">
                				<div class="form_left">
									...
									<div class="input-text">
										...
										<div class="input-select">
											<div class="req">*</div>
											<select name="league" id="league" onchange="toggle_wepay(this.value)">
									...
									<div class="input-text">
										...
										<div class="input" style="width:100px">											
											<input type ="text" name ="jersey_size" id="jersey_size" />
										</div>
										<div class="clear"></div>										
									</div>
									<div class="input-text">
										...
										<div class="input"  style="width:100px">											
											<input type ="text" name ="jersey_no" id="jersey_no" />
										</div>
										<div class="clear"></div>										
									</div>
									<div class="input-text">
									...
									<div class="input-button">
										<input type="button" id="btnReferesh" value="   Submit   " onclick="Ext.bhl.proc();" />
									</div>
								...
								<div class="form_right">									
									...
									<div id="fade" class="pics">
							            <img src="bhleague_logos/brick_city_w.png" width="100%"/>
										<img src="bhleague_logos/clubbers_w.png" width="100%"/>
										<img src="bhleague_logos/flamingos_w.png" width="100%"/>										
										<img src="bhleague_logos/knicks_w.png" width="100%"/>										
							        </div>
								</div>
								<div class="padding_clear"></div>
