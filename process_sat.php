		...
		*/
		...
		if(isset($jsonReturn->user_id) && isset($jsonReturn->access_token) && isset($jsonReturn->token_type))		{
			...
			*/			
			...
			$arguments = array('account_id'=>$jsonReturn_payment->account_id, 'amount'=>'150.00', 'short_description'=>BHLEAGUE_ACCOUNT_SAT, 'type'=>'DONATION', 'redirect_uri'=>WEPAY_THANKYOU_URI);//XXXXXXXXXXXXXXXXXXXXXXXXXXXX
			curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
			curl_setopt($ch, CURLOPT_POST, true);
