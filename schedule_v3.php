...
if ($rs = $db->query($sql)) {
	...
	while($obj = $rs->fetch_assoc()){
		...
		{
		@$obj['teams'] = "<a href='http://www.bhleague.com/games_v3.php?gamedate=".$obj['game_date']."&team1=".$obj['team1']."&team2=".$obj['team2']."' target='_self'>".$myarr[$obj['team1']]." vs. ".$myarr[$obj['team2']]."</a>";
